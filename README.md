...
# Let´s add new Data from today´s news
...
- In order to see the changes I have implemented in the index, a function that depending on the button we are pressing you get one results or other :
